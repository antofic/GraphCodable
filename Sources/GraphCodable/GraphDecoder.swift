...
public final class GraphDecoder {
	...
	public func decode<T>( _ type: T.Type, from data: some DataProtocol ) throws -> T
	where T:GDecodable {
	...
	public func dump( from data: some DataProtocol, options: GraphDumpOptions = .readable ) throws -> String {
	...
	/// by the `encode(...)` function.
	public func isCyclic( from data: some DataProtocol ) throws -> Bool {
	...
	public func encodedArchiveIdentifier( from data: some DataProtocol ) throws -> String? {
